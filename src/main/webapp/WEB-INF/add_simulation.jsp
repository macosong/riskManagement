...
<div>
    ...
    <div class="container" style="padding-top: 9%;">
        ...
        <form class="form-horizontal" id="add_simulation_form"
              action="add_simulation.action" >
            <h3 class="form-title" >添加模拟词条</h3>

           
                        <div class="form-group" >
                            <label class="col-sm-2 control-label float-left">名称</label>
                            <div class="col-sm-4 ">
                                <input name="simulationName" id="simulationName" class="form-control" placeholder=""  type="text">
                            </div>
                        </div>
                 <div class="form-group">
                               <br>
            ...
            <!--隐藏一个审核标志，设置为1！！！-->
            <div class="form-group">
                <button class="btn btn-default btn-lg col-sm-4 col-sm-offset-4" id="btn_add_simulation"  type="submit">添加</button>
            </div>
