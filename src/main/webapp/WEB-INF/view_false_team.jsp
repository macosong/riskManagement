    ...
    <div class="col-md-12 col-md-offset-0">
        <ul class="list-group">
            ...
            <a href="view_false_team">
                <li class="list-group-item  active" style="height: 50px;text-align: center">查看虚开团伙</li>
            </a>
            <a href="add_admin">
...
<div id="false_team_table">
        <table  class="table table-hover table-condensed " style="background: white;color: #1b81ea">
            ...
            <tr style="font-size: 14px;" align="center">
                ...
                <th style="text-align: center">团伙类型</th>
			...
			<tr v-for="(item,index) in pageInfo.list" style="font-size: 14px;" align="center">
				<td>{{item.falseTeamId}} <input id="falseTeamId" type="hidden" ></td>
				<td>{{item.falseTeamType}} <input id="falseTeamType" type="hidden" ></td>
				<td>{{item.falseTeamIncharge.inchargePerName}} <input id="inchargePerName" type="hidden" >
				<input id="inchargePerId" type="hidden">
				<input id="taxPayerId" type="hidden">
				</td>
	...
	data:{
	 ...
	 methods:{  
         onclick:function(index){  
         	document.getElementById("falseTeamId").value=vue.pageInfo.list[index].falseTeamId;
         	document.getElementById("falseTeamType").value=vue.pageInfo.list[index].falseTeamType;
         	document.getElementById("inchargePerName").value=vue.pageInfo.list[index].falseTeamIncharge.inchargePerName;
         	document.getElementById("inchargePerId").value=vue.pageInfo.list[index].falseTeamIncharge.inchargePerId;
         	document.getElementById("taxPayerId").value=vue.pageInfo.list[index].falseTeamIncharge.taxPayerId;
         ...
         getList : function(page) {
				...
				$.ajax({
							url : 'view_false_team.action?page='+rpage,
							type : 'get',
							dataType : 'json',
							async : false,
...
$(document).ready(function(){
	$.get("view_false_team.action",null,function(data){
