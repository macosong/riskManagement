...
<div class="container" style="padding-top: 15%;padding-right: 800px;padding-left: 0px;border-left-style: solid;border-left-width: 0px;margin-left: 50px;">
    ...
    <div class="col-md-12 col-md-offset-0">
        <ul class="list-group">
            ...
            <a href="view_invoice">
                <li class="list-group-item active" style="height: 50px;text-align: center">查看发票</li>
            </a>
            <a href="view_buy">
...
<!--右侧列表-->
        ...
        <div id="invoice_table">
            <table   class="table table-hover table-condensed " style="background: white;color: #1b81ea">
                ...
                <tr style="font-size: 14px;" align="center">
                    ...
                    <th style="text-align: center">销售方ID</th>
                    <th style="text-align: center">购货方ID</th>
                </tr>
			...
			<tr v-for="item in pageInfo.list" style="font-size: 14px;" align="center">
				...
				<td>{{item.purSaleDate}}</td>
				<td>{{item.providerTaxPayerId}}</td>
				<td>{{item.buyerTaxPayerId}}</td>
			</tr>
	...
	//vue列表获取数据
		var vue = new Vue({
			...
			methods:{  
                ...
                getList : function(page) {
					...
					$.ajax({
								url : 'view_invoice.action?page='+rpage,
								type : 'get',
								dataType : 'json',
								async : false,
		...
		$(document).ready(function() {
			$.get("view_invoice.action", null, function(data) {
				vue.pageInfo = data;
