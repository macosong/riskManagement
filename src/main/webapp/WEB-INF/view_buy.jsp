...
<div class="container" style="padding-top: 15%;padding-right: 800px;padding-left: 0px;border-left-style: solid;border-left-width: 0px;margin-left: 50px;">
    ...
    <div class="col-md-12 col-md-offset-0">
        <ul class="list-group">
            ...
            <a href="view_buy">
                <li class="list-group-item active" style="height: 50px;text-align: center">查看购货台账</li>
            </a>
            <a href="view_pur">
 ...
 <script>
	//vue列表获取数据
		var vue = new Vue({
			...
			methods:{  
                ...
                getList : function(page) {
					...
					$.ajax({
								url : 'view_buy.action?page='+rpage,
								type : 'get',
								dataType : 'json',
								async : false,
		...
		$(document).ready(function() {
			$.get("view_buy.action", null, function(data) {
				vue.pageInfo = data;
